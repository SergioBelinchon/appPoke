...
class SeptimaGenActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_septima_gen)

        val septimaGenPokedex = intent.getSerializableExtra("septimaGenPokedex") as List<Pokemon>?
        displayPokemonTable(septimaGenPokedex)
    ...
    private fun displayPokemonTable(pokemonList: List<Pokemon>?) {
        ...
        pokemonList?.forEach { pokemon ->
            ...
            addTextViewToRow(tableRow, "Alola")


            tableRow.setOnClickListener {
                val intent = Intent(this@SeptimaGenActivity, PokemonDetailActivity::class.java)
