...
class QuintaGenActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_quinta_gen)

        val quintaGenPokedex = intent.getSerializableExtra("quintaGenPokedex") as List<Pokemon>?
        displayPokemonTable(quintaGenPokedex)
    ...
    private fun displayPokemonTable(pokemonList: List<Pokemon>?) {
        ...
        pokemonList?.forEach { pokemon ->
            ...
            addTextViewToRow(tableRow, "Teselia")


            tableRow.setOnClickListener {
                val intent = Intent(this@QuintaGenActivity, PokemonDetailActivity::class.java)
