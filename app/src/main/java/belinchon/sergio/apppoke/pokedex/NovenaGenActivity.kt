...
class NovenaGenActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_novena_gen)

        val novenaGenPokedex = intent.getSerializableExtra("novenaGenPokedex") as List<Pokemon>?
        displayPokemonTable(novenaGenPokedex)
    ...
    private fun displayPokemonTable(pokemonList: List<Pokemon>?) {
        ...
        pokemonList?.forEach { pokemon ->
            ...
            addTextViewToRow(tableRow, "Paldea")


            tableRow.setOnClickListener {
                val intent = Intent(this@NovenaGenActivity, PokemonDetailActivity::class.java)
