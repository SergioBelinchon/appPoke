...
class SextaGenActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_sexta_gen)

        val sextaGenPokedex = intent.getSerializableExtra("sextaGenPokedex") as List<Pokemon>?
        displayPokemonTable(sextaGenPokedex)
    ...
    private fun displayPokemonTable(pokemonList: List<Pokemon>?) {
        ...
        pokemonList?.forEach { pokemon ->
            ...
            addTextViewToRow(tableRow, "Kalos")


            tableRow.setOnClickListener {
                val intent = Intent(this@SextaGenActivity, PokemonDetailActivity::class.java)
